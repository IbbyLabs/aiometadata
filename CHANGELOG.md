...
## [3.0.0](https://github.com/IbbyLabs/aiometadata/compare/v2.8.0...v3.0.0) (2026-08-20)
...
* add "This Season" filter and dynamic genres for anime discover ([68382d0](https://github.com/IbbyLabs/aiometadata/commit/68382d0c7832126d9e6091aafbd91ecf59e707e5))
* add AI Catalog Builder for natural language catalog creation ([8e230c4](https://github.com/IbbyLabs/aiometadata/commit/8e230c474be4fd4a577f88d81f76bf76438248a7))
* add API key placeholders ({rpdb_key}, {tmdb_key}, etc.) in URL patterns ([c2c2e67](https://github.com/IbbyLabs/aiometadata/commit/c2c2e67df18baa8386ae1e90bcb5827f225b4a63))
* add bulk select-by-type for catalogs ([82e27f6](https://github.com/IbbyLabs/aiometadata/commit/82e27f6cea7cc264c316080cca81aa35d431e2f8))
* add cache compression ([1c27005](https://github.com/IbbyLabs/aiometadata/commit/1c270057a12d1351e65d26d2969b9341acac953b))
* add certification range filters and fix MAL airing cache TTL ([26f3b7e](https://github.com/IbbyLabs/aiometadata/commit/26f3b7e6a277c4e6d57d4217b1860ae229de5280))
* add configurable minimum votes for tmdb.year catalog ([07db94a](https://github.com/IbbyLabs/aiometadata/commit/07db94a55bc9ca48efbd81ac6d102045896ff7c7))
* add discover catalog duplicate button and rename DiscoverBuilderDialog ([47a3c55](https://github.com/IbbyLabs/aiometadata/commit/47a3c558f4a4b7b5752f030c6f13f5ba23fafe90))
* Add easy catalog share option ([af9dc18](https://github.com/IbbyLabs/aiometadata/commit/af9dc182bd9a1b80ae7e07b4a3c5935d85c02393))
* add episode thumbnail URL pattern support ([c2c2e67](https://github.com/IbbyLabs/aiometadata/commit/c2c2e67df18baa8386ae1e90bcb5827f225b4a63))
* add filter to hide unreleased shows from catalogs and search ([f924e8a](https://github.com/IbbyLabs/aiometadata/commit/f924e8ab595f7faef409b2fdf5c405f212c4851d))
* add filtering to kitsu, batch calls better ([ee5249a](https://github.com/IbbyLabs/aiometadata/commit/ee5249a591d427f9368191f40215f89a835a5bcb))
* add heap profile to dashboard operations tab ([34a8572](https://github.com/IbbyLabs/aiometadata/commit/34a85721a4d9e8e83f48d292d78017b291682670))
* add MDBList recommendation catalogs ([d71a5d5](https://github.com/IbbyLabs/aiometadata/commit/d71a5d5ef4f20ec1e1387958dca510cbc800b195))
* add merged catalogs ([832dc85](https://github.com/IbbyLabs/aiometadata/commit/832dc85e5d0a756d70af47f4563a4623369de2c2))
* add META_CONCURRENCY env to cap getMeta fan-out and HEAP_LOG_INTERVAL_MIN for periodic heap logging ([17c900d](https://github.com/IbbyLabs/aiometadata/commit/17c900d2411ecba2cb66e5a3353d74aabc30dec0))
* add MyAnimeList integration with watch tracking and list catalogs ([91e97e5](https://github.com/IbbyLabs/aiometadata/commit/91e97e58c044a59c642c621a5d2cd38355ba230e))
* add opt-in built-in poster cache with dashboard log integration ([153cd15](https://github.com/IbbyLabs/aiometadata/commit/153cd152e103e4f80f158a3eeaa53645096cfb62))
* add original language poster fallback toggle in art providers settings ([68d40bf](https://github.com/IbbyLabs/aiometadata/commit/68d40bf14c3aea349ee65675139adc4394129fc6))
* add PMDB settings dialog with cache TTL controls ([6d6375f](https://github.com/IbbyLabs/aiometadata/commit/6d6375f27bc1595a605189859e3ed009effb9fd2))
* add poster cache management to admin dashboard ([d74ab9c](https://github.com/IbbyLabs/aiometadata/commit/d74ab9c5204af11d25bba1e8830508bc94ca6b6b))
* add PublicMetaDB integration (up next, lists, watch tracking) ([ae0c2f3](https://github.com/IbbyLabs/aiometadata/commit/ae0c2f3e22605c0452d36aa9ab3a75f69da3aa77))
* add restart-from-UI for settings that require a reboot ([17ca283](https://github.com/IbbyLabs/aiometadata/commit/17ca283790dcedb525441748cf238d9015f8128e))
* add search pagination support ([696ecd7](https://github.com/IbbyLabs/aiometadata/commit/696ecd779e5c48d78931b03ce04c51bee8ec15d4))
* add simkl curated recipe catalogs ([0423159](https://github.com/IbbyLabs/aiometadata/commit/042315980c5bc2d13528d20649c76c253615e85b))
* add timeframe selector to dashboard content tab (today/week/month/all) ([67ab246](https://github.com/IbbyLabs/aiometadata/commit/67ab2464ff2c4fa53960d30f6149a4f346e483f3))
* add Trakt Anticipated Movies/Shows catalogs ([50cba80](https://github.com/IbbyLabs/aiometadata/commit/50cba808ad0072b63523d93778985cba58ccd71f))
* add unified import option for MDBList dynamic mixed lists ([5d6e9d3](https://github.com/IbbyLabs/aiometadata/commit/5d6e9d34bfc98a67b85b4720efcd6407546cb4db)), closes [#415](https://github.com/IbbyLabs/aiometadata/issues/415)
* add weekly seasonal MAL catalogs ([04ae910](https://github.com/IbbyLabs/aiometadata/commit/04ae91093ac0e4636d98d78856b6493acfbd0594))
* add with_networks filter to tmdb discover series builder ([2e80228](https://github.com/IbbyLabs/aiometadata/commit/2e80228fc50776d80cdd174e6eb92af17797606e))
* aggregate dashboard system stats over full DB (streaming fold + gated Postgres SQL) ([0a861f5](https://github.com/IbbyLabs/aiometadata/commit/0a861f5853c2e6841e348602b7f42efb990a1118))
* AI search model selection and OpenRouter support ([ec3829d](https://github.com/IbbyLabs/aiometadata/commit/ec3829d7d7cbc33875f15bf04fd7b719ea5cf289))
* AIOMetadata 2.0.0 ([5c1d102](https://github.com/IbbyLabs/aiometadata/commit/5c1d102009b7e435d4910a2893dda4db7fb53212))
* AIOMetadata integration modal, deletable default catalogs, TMDB_API_KEY rename & docs ([1305c3f](https://github.com/IbbyLabs/aiometadata/commit/1305c3fb30a913074d1ca7df4af4afb858728a9e))
* anime IMDB to TMDB resolution for watch tracking ([e7cffd7](https://github.com/IbbyLabs/aiometadata/commit/e7cffd7eb1622cf6bd9b2ed8bd1feb11d38f82b7))
* AsyncLocalStorage-based UUID propagation for log entries ([bb60262](https://github.com/IbbyLabs/aiometadata/commit/bb60262ebcc49d335940a04832637f4525a91078))
* bounded log buffer with redaction + self-backfilling SSE log stream ([9a4793a](https://github.com/IbbyLabs/aiometadata/commit/9a4793a1a3a839b5c0cea946852a4b4c4b7ce5ac))
* **byoc:** add MDBList Discover as a BYOC source with user info display ([44e04a0](https://github.com/IbbyLabs/aiometadata/commit/44e04a0687eacb0d2693c531a2a0e2f8de62cf1d))
* catalog tags with per-tag manifest profiles ([e4d801a](https://github.com/IbbyLabs/aiometadata/commit/e4d801a3e1bab121287ee9ea78d881c52b2a67c4))
* compact Error Management UI in ops tab ([d93ab67](https://github.com/IbbyLabs/aiometadata/commit/d93ab67b8afa9b1c6b83df69c12fd294d97b989a))
* **configure:** move custom art URL fields into poster rating provider selector ([a00222e](https://github.com/IbbyLabs/aiometadata/commit/a00222ea60e8e4a19b114365fcb33d7c38994fc0))
* cursor-based pagination for custom catalogs ([c1ec9f3](https://github.com/IbbyLabs/aiometadata/commit/c1ec9f3fdd3d18c82c5b3ba726e2cbc9451d4e56))
* custom addon name and fix RPDB toggle shared state ([bcde593](https://github.com/IbbyLabs/aiometadata/commit/bcde593b7bf58a3a2e643f6d671950bc9349e3f1))
* custom poster URL pattern support ([6bab526](https://github.com/IbbyLabs/aiometadata/commit/6bab526230ff4229796195a86edf81d74951823a))
* **custom-art:** add raw {id} placeholder support ([0a95fe6](https://github.com/IbbyLabs/aiometadata/commit/0a95fe6aa27cf00080dd739466d5a86e6856c48c))
* dashboard logs tab + component extraction into dashboard/ folder ([ccdab82](https://github.com/IbbyLabs/aiometadata/commit/ccdab829155d3f08a432fcee0b38da06000c9026))
* dashboard settings tab with runtime env management ([9f58d36](https://github.com/IbbyLabs/aiometadata/commit/9f58d361b154e8d425dbab8528df201acb240f03))
* display localized age rating based on user's language country ([8573e14](https://github.com/IbbyLabs/aiometadata/commit/8573e14fe164fdedf8035333ffaff3b4b0959551))
* enforce env-registry coverage and backfill dashboard settings ([3935e2e](https://github.com/IbbyLabs/aiometadata/commit/3935e2e51f3854ac3abb0776afb6db9643725113))
* extend custom art URL patterns to background, logo, and anime IDs ([3f6ae5e](https://github.com/IbbyLabs/aiometadata/commit/3f6ae5e29a715cdcfc8d5b5b662e01c457654a1b))
* extend usePosterProxy fallback to logo and backdrop ([c1ec9f3](https://github.com/IbbyLabs/aiometadata/commit/c1ec9f3fdd3d18c82c5b3ba726e2cbc9451d4e56))
* hide watched items from catalogs (Trakt, AniList, MDBList) ([5fedaa8](https://github.com/IbbyLabs/aiometadata/commit/5fedaa85febee5b35f84eabb364ddc4a937640b6))
* **id-mapper:** resolve ONA type via Trakt dataset and TMDB API ([a00222e](https://github.com/IbbyLabs/aiometadata/commit/a00222ea60e8e4a19b114365fcb33d7c38994fc0))
* import private lists from connected Trakt account by entering own username ([61b2b08](https://github.com/IbbyLabs/aiometadata/commit/61b2b08e584e8f55ee8897117c0e0d4ffe885542))
* make MAL/Jikan page size configurable via MAL_PAGE_SIZE ([04ae910](https://github.com/IbbyLabs/aiometadata/commit/04ae91093ac0e4636d98d78856b6493acfbd0594))
* **mdblist:** add option to filter out unreleased shows from up next as shown in mdblist UI ([847fb28](https://github.com/IbbyLabs/aiometadata/commit/847fb28901e7ea8f550fb8cda219758925585fee))
* move art URL overrides UI from Integrations to Art Providers tab ([c2c2e67](https://github.com/IbbyLabs/aiometadata/commit/c2c2e67df18baa8386ae1e90bcb5827f225b4a63))
* only advertise subtitles resource when watch tracking is enabled ([23a10cb](https://github.com/IbbyLabs/aiometadata/commit/23a10cb0d106f42c18cae2273d70a99f1fa60288))
* poster reverse proxy prefix and cache warming ([0b7050a](https://github.com/IbbyLabs/aiometadata/commit/0b7050a4d34719e42c00fac1f3827cfee2f81634))
* **regexFilter:** add genre exclusion to content exclusion filter ([a00222e](https://github.com/IbbyLabs/aiometadata/commit/a00222ea60e8e4a19b114365fcb33d7c38994fc0))
* revamp dashboard logs and overview tabs ([9099dc5](https://github.com/IbbyLabs/aiometadata/commit/9099dc5adf373b790d078d7d506f459444229f18))
* revamp dashboard tabs — extract components, add user config insights ([53ee24f](https://github.com/IbbyLabs/aiometadata/commit/53ee24ff98df4a116555f51e511dc66d4deab6b2))
* scroll-spy sidebar layout for configure UI ([e0d38c7](https://github.com/IbbyLabs/aiometadata/commit/e0d38c7029fe097d74bbd475fe375f87f12b9ba3))
* show recent dev commits for testing channel in changelog ([caf7675](https://github.com/IbbyLabs/aiometadata/commit/caf7675b29fdb2ff467c679fe2e7324ea9c6cc8e))
* show reinstall warning when manifest-affecting config changes are saved ([5c02eb4](https://github.com/IbbyLabs/aiometadata/commit/5c02eb477d200e04c06245cda28fd304f438e101))
* **simkl:** add simkl latest dvd release catalog ([b26fb75](https://github.com/IbbyLabs/aiometadata/commit/b26fb75b4119c11bd84d7bc1408d9b07d63ddc8b))
* streaming top 10 catalogs integration ([59de923](https://github.com/IbbyLabs/aiometadata/commit/59de923aff3a3d9924d771db6977ddc3cb038a3d))
* support FANART_API_PROJECT_KEY with user keys as clientKey ([4e93312](https://github.com/IbbyLabs/aiometadata/commit/4e933120f23ff18eba5b452be1f0cfe199374657))
* support FANART_API_PROJECT_KEY with user keys as clientKey ([6101409](https://github.com/IbbyLabs/aiometadata/commit/61014094aeeef8b4e0276334b893b17bd0f80e82))
* support read replica and DDL gating for geo-redundancy ([cebae83](https://github.com/IbbyLabs/aiometadata/commit/cebae83a44f8be2b575a19dd5aad44dde5f06009))
* **trakt:** add "default" as sort option ([04247c1](https://github.com/IbbyLabs/aiometadata/commit/04247c142a71cddce6287ab4e3120d5e27f1c698))
* **trakt:** add trakt check in ([b26fb75](https://github.com/IbbyLabs/aiometadata/commit/b26fb75b4119c11bd84d7bc1408d9b07d63ddc8b))
* **ui:** add show/hide all toggle for API key fields ([6990ca5](https://github.com/IbbyLabs/aiometadata/commit/6990ca5a83a85be153f5cddbf3ce11f3b888bc66))
* **ui:** stack logo above addon name on mobile ([6990ca5](https://github.com/IbbyLabs/aiometadata/commit/6990ca5a83a85be153f5cddbf3ce11f3b888bc66))
* unify poster rating into custom art URL patterns with post-processing ([c2c2e67](https://github.com/IbbyLabs/aiometadata/commit/c2c2e67df18baa8386ae1e90bcb5827f225b4a63))
* update Top Posters API domain and add user-agent support ([4ef0187](https://github.com/IbbyLabs/aiometadata/commit/4ef0187e60f6f3da9c217530a84e616f45321cb4))
* update Top Posters API domain and add user-agent support ([1995e86](https://github.com/IbbyLabs/aiometadata/commit/1995e8691e9f2dc1c9c8ff87e16b411cfec352b8))
* warm custom poster pattern URLs during comprehensive catalog warming ([bf441f9](https://github.com/IbbyLabs/aiometadata/commit/bf441f9ecaad59413292219ad08218c076c22272))


### Bug Fixes

* add available flag to TMDB series episode videos ([4f9590e](https://github.com/IbbyLabs/aiometadata/commit/4f9590ed2711e1ac94dda0b7e20d0618e474b5a5))
* add experimental TMDB/IMDB fallback episode matching logic ([3559037](https://github.com/IbbyLabs/aiometadata/commit/35590374b78b6d7c7f60b0cccd4fbe744dbc3ae3))
* add oom guardrails to maps ([1ef7706](https://github.com/IbbyLabs/aiometadata/commit/1ef77069e5e78f4667fa0d514059eb480354d6cf))
* add oom guardrails to maps ([1a382f1](https://github.com/IbbyLabs/aiometadata/commit/1a382f18ed0a99368230208ae064d799f336e016))
* add pmdb_resume_ prefix to upnext fallback and manifest idPrefixes ([ac4d84f](https://github.com/IbbyLabs/aiometadata/commit/ac4d84f6bb9efb8cb4aceaae284363fd6812b3f2))
* AI catalog TTL, warmer hot-reload, and stale env reads ([4838c2b](https://github.com/IbbyLabs/aiometadata/commit/4838c2bc9a8c7c06435b54b59e629058caeae9cc))
* allow admin to set custom password on user password reset ([5aa8106](https://github.com/IbbyLabs/aiometadata/commit/5aa8106d98eaf0dd6c070d2ec1491dcfda5369c1))
* allow breaking out of live log auto-scroll via wheel, touch, and keyboard ([71d1b05](https://github.com/IbbyLabs/aiometadata/commit/71d1b05a0a3fe1804ed77f07404a2f0580e8e3d1))
* allow enabling rating posters with custom url patterns ([645a773](https://github.com/IbbyLabs/aiometadata/commit/645a7738d7a99f9caa7acdb9f6d1a23853c44430))
* always populate certification for tvdb metas so age-rating filtering works when the rating display toggle is off ([9dd510c](https://github.com/IbbyLabs/aiometadata/commit/9dd510c1475bc4eb216a619cd969fa240651092c))
* **anilist:** stable pagination and sort-aware caching ([ebab787](https://github.com/IbbyLabs/aiometadata/commit/ebab787cbef178f172cedb04ff97ae5ff94c5ce6))
* anime movie ID resolution fallbacks in getMeta ([bd494c3](https://github.com/IbbyLabs/aiometadata/commit/bd494c374f4dc769992c10a7e500484534ab3565))
* apply age-rating filter using canonical catalog type, not localized ([960dc78](https://github.com/IbbyLabs/aiometadata/commit/960dc78223d8f87e2213477de0be630f8113f0c7))
* apply castCount projection at read time so changes take effect without reinstall ([876da47](https://github.com/IbbyLabs/aiometadata/commit/876da473f943875b59469de12512921ea021f356))
* apply tmdb discover series runtime filter locally with episode fallbacks ([f9b173c](https://github.com/IbbyLabs/aiometadata/commit/f9b173cf57b9a2d9b8bf1582249c56fb0ed7a3f1))
* authenticate public Trakt list requests to bypass stale CDN cache ([0eca2b5](https://github.com/IbbyLabs/aiometadata/commit/0eca2b5370b07d3f4fc004453d0302c15f8bd31d))
* avoid duplicate Cinemeta fetch for TMDB series ([309fa68](https://github.com/IbbyLabs/aiometadata/commit/309fa683c5862c4fdedf5f896193dfb0bcb1dd50))
* avoid full metadata fanout in tvmaze schedule catalog ([7dd840e](https://github.com/IbbyLabs/aiometadata/commit/7dd840e815fbb38c246360c82c8226bcf2fb6d5e))
* bump version ([#363](https://github.com/IbbyLabs/aiometadata/issues/363)) ([c031827](https://github.com/IbbyLabs/aiometadata/commit/c031827a4679955ae5e4a87a5f5ba2f028119c6b))
* **BYOC:** fix air dates not being set correctly for tmdb now airing ([b3ba6bc](https://github.com/IbbyLabs/aiometadata/commit/b3ba6bc397d14cf07b2cfc96366e9201bfce8474))
* **BYOC:** fix catalog context not being reset for cloned catalogs ([b3ba6bc](https://github.com/IbbyLabs/aiometadata/commit/b3ba6bc397d14cf07b2cfc96366e9201bfce8474))
* **byoc:** preserve randomization on save, fix MAL catalog type, and prevent state leaking between edits ([bd023d9](https://github.com/IbbyLabs/aiometadata/commit/bd023d96e86bf39963614ea13b4436f3beadf251))
* bypass outer cache wrapper for custom/stremthru catalogs ([17e7df9](https://github.com/IbbyLabs/aiometadata/commit/17e7df9b0f70f87f33a2840aa0dd3ccf772538d5))
* cache auth tokens by api key instead of user UUID ([f545971](https://github.com/IbbyLabs/aiometadata/commit/f545971f59fe35a54c5ca5151e0d61c89494b3a8))
* cache key invalidation for anime-scoped catalogs ([8707bbb](https://github.com/IbbyLabs/aiometadata/commit/8707bbba5075437490a409df706e966b54e2af70))
* carry status into anime catalog meta and treat unreleased/tba as unreleased ([4960695](https://github.com/IbbyLabs/aiometadata/commit/4960695b587bc2bdfbea20eaacb2d5c0369ac211))
* cast config_data to jsonb in postgres user queries ([9075da3](https://github.com/IbbyLabs/aiometadata/commit/9075da3bc7cfaa2ce8fe017386dcfe657445c440))
* clear ONA type cache on reindex ([7179dca](https://github.com/IbbyLabs/aiometadata/commit/7179dca4508ed6521072688146929f476c95412a))
* clear reinstall banner after non-manifest saves and reinstall ([0333a71](https://github.com/IbbyLabs/aiometadata/commit/0333a71dcdb48a97e7a5bc45bf1d75059cb3efe2))
* comprehensive warmup ignoring per-catalog enableRatingPosters setting ([8707bbb](https://github.com/IbbyLabs/aiometadata/commit/8707bbba5075437490a409df706e966b54e2af70))
* correct TVDB language code mapping for Portuguese regional variants ([1a1c6d1](https://github.com/IbbyLabs/aiometadata/commit/1a1c6d1ae1b04b1ffd5b305ff5f99378463b1775))
* country-aware TVDB age ratings with TMDB fallback and caching ([164f038](https://github.com/IbbyLabs/aiometadata/commit/164f03828ab73e78d0b6bd06387285ae35d35445))
* crash when config.language is undefined in selectTmdbImageByLang ([3bae00e](https://github.com/IbbyLabs/aiometadata/commit/3bae00eff131724ac6f0e6087fbe9179bcf08898))
* crash when config.language is undefined in selectTmdbImageByLang ([4ca72f6](https://github.com/IbbyLabs/aiometadata/commit/4ca72f665d235f08937514d67284e59560159a03))
* dashboard content tab always returning top 10 regardless of limit selection ([0c21fae](https://github.com/IbbyLabs/aiometadata/commit/0c21fae31e499c21e3055cddf5faa5173990650c))
* disable HTTP/2 globally to prevent GOAWAY errors ([e768239](https://github.com/IbbyLabs/aiometadata/commit/e76823930c268ad2bbe3db42d1eebb1de41a9e34))
* don't cache degraded provider fallbacks on transient upstream errors ([f9af96c](https://github.com/IbbyLabs/aiometadata/commit/f9af96c863b7151e8554f1972175510431278adf))
* don't cache N/A imdb rating while the ratings dataset is unavailable ([b39f649](https://github.com/IbbyLabs/aiometadata/commit/b39f6496ce9163e1adff60d3800331111057361e))
* eliminate OOM from OAuth handlers loading all configs into memory ([cebff85](https://github.com/IbbyLabs/aiometadata/commit/cebff85ca5577ecb892b1261e71b081b7180f3fd))
* exclude videos array when unnecessary ([1049ce3](https://github.com/IbbyLabs/aiometadata/commit/1049ce31ce7a7d2aa6f78bbf78d2a70d84cf0577))
* fallback stale upnext meta ids to canonical series ([8c2ce3b](https://github.com/IbbyLabs/aiometadata/commit/8c2ce3becddf6ca858d1e1ccb89d44cf47ea7c70))
* fallback stale upnext meta ids to canonical series ([afd80e3](https://github.com/IbbyLabs/aiometadata/commit/afd80e3c67f9f279d8c7a7672c7bbccf3c5ef068))
* fallback to skip offset on cursor mismatch instead of returning empty ([d80c7c4](https://github.com/IbbyLabs/aiometadata/commit/d80c7c463774ba9289fd64e9791b235ecc697f68))
* FlixPatrol fallback ISO country codes to slug names ([467396d](https://github.com/IbbyLabs/aiometadata/commit/467396de92eded72fe1c94ea86810f3b8327ede1))
* fribb parsing ([fcfeeb4](https://github.com/IbbyLabs/aiometadata/commit/fcfeeb4cc6b4da6811af330d93516ba8c7c6faf7))
* **getCache:** remove post-processing config from cache keys ([a00222e](https://github.com/IbbyLabs/aiometadata/commit/a00222ea60e8e4a19b114365fcb33d7c38994fc0))
* guard simkl check-in against stale tokens ([881f329](https://github.com/IbbyLabs/aiometadata/commit/881f329434f31b91055a854389c5d107f53e80a4))
* handle displayType suffix in merged catalog manifest ordering ([b250a30](https://github.com/IbbyLabs/aiometadata/commit/b250a3056693ea40f84bb251208becdeb46c2e75))
* handle Fribb themoviedb_id.movie arrays and index all imdb/tmdb ids ([76e0a25](https://github.com/IbbyLabs/aiometadata/commit/76e0a258b537878e27c6c46011526572ebdb4c5a))
* handle SIGTERM/SIGINT for graceful shutdown ([6f20c53](https://github.com/IbbyLabs/aiometadata/commit/6f20c5375a05a1ed32854fa16fbe33ffd59d7e45))
* hide unreleased series with not-yet-aired status and null release date ([637680e](https://github.com/IbbyLabs/aiometadata/commit/637680ee189c6394724669fb6c9d4707bac70fba))
* ignore Vary header in poster-cache and add concurrent warming ([9205bb9](https://github.com/IbbyLabs/aiometadata/commit/9205bb9391d802e8838609fc1f49b291c95d5857))
* improve dashboard logs, settings, content, and tab navigation on mobile ([ca01188](https://github.com/IbbyLabs/aiometadata/commit/ca011882edc24b7c3d4e6f16aba140923f5c7d8a))
* improve ID propagation for rating posters translation ([15bd79e](https://github.com/IbbyLabs/aiometadata/commit/15bd79e12c5c50fda64945fbb07d496eb0ae0a31))
* include animeIdProvider in meta cache key when forceAnimeForDetectedImdb is on ([2a5f181](https://github.com/IbbyLabs/aiometadata/commit/2a5f181ab39b032fd9d8975c764216a2dbcd9b33))
* include custom cacheTTL in mdblist cache keys ([1365a82](https://github.com/IbbyLabs/aiometadata/commit/1365a82a0006dfc1cfa0782fb36af1adbda0571a))
* include custom cacheTTL in trakt personal list cache keys ([6fe3f2d](https://github.com/IbbyLabs/aiometadata/commit/6fe3f2deebdda7faec18faa38ba365b1e24e830c))
* include custom display types in Select by Type filter ([b64f3ab](https://github.com/IbbyLabs/aiometadata/commit/b64f3ab04631108e45eafc8cc12ef7b2395376a7))
* include disabled merge sources when building genres for merged catalogs ([dc42b17](https://github.com/IbbyLabs/aiometadata/commit/dc42b17ec89948611e4f58b380ad0422064d8548))
* include TV-Y and TV-Y7 in age-rating catalog filter ([cd71ffd](https://github.com/IbbyLabs/aiometadata/commit/cd71ffd1f6c0dc4fb9fde1c7862d9a094e9e6d30))
* insert duplicated discover catalog below the original ([e1569a5](https://github.com/IbbyLabs/aiometadata/commit/e1569a532c056732ea162bb5ee068acc2ba43bb7))
* invalidate simkl watchlist cache on activity change ([ec9956e](https://github.com/IbbyLabs/aiometadata/commit/ec9956e7c38bc81b7056d57a38672dff4ef11faf))
* invalidate Trakt tokens on 400, surface expired status in UI ([96a73d0](https://github.com/IbbyLabs/aiometadata/commit/96a73d08052aec0ae41e3e22deea854556d280fe))
* Letterboxd identifier extraction blocked by Cloudflare ([b1a2158](https://github.com/IbbyLabs/aiometadata/commit/b1a215844af8a0eafd005cf34735aaa75a7b76cc))
* MAL seasons 504 errors — drop broken sfw param, decode genre URI ([d27235d](https://github.com/IbbyLabs/aiometadata/commit/d27235ddcf0f92c686c824b2965c76558fa461e5))
* **mal:** restore sfw param to mal seasons catalog fetching following resolution of 504 error from jikan and add missing genres property for MAL catalog meta. ([4661e98](https://github.com/IbbyLabs/aiometadata/commit/4661e987e866c3e81997fe67bdd6658581d0a82f))
* manifest ordering id-only fallback for displayType overrides ([cf133b0](https://github.com/IbbyLabs/aiometadata/commit/cf133b0a2ba60f47693c602d19710152378b814b))
* match catalog tags case-insensitively and warn on duplicates ([77d6766](https://github.com/IbbyLabs/aiometadata/commit/77d67666102836a2175681f2e0bdb6374ebceede))
* MDBList anime genre filter sending title instead of slug ([448ae91](https://github.com/IbbyLabs/aiometadata/commit/448ae91cfaa76e8a2f9a7e705aec545e8911a205))
* mdblist upnext cache key, skip caching empty mdblist results, lightweight healthcheck ([db6fc70](https://github.com/IbbyLabs/aiometadata/commit/db6fc70dc0e701b20b114e9bfcc687118137d55b))
* **mdblist:** fix meta issue arising when use show poster was on for mdb upnext ([7536c8e](https://github.com/IbbyLabs/aiometadata/commit/7536c8e9346ea0cde551e20699c52a869da3b697))
* **mdblist:** use list.shows instead of list.items_shows to get shows count ([c8cf543](https://github.com/IbbyLabs/aiometadata/commit/c8cf543d90a98216bd146ffa8994aca51bb63ca4))
* mobile drag-to-sort: add TouchSensor with activation constraints, touch-none on all drag handles ([640436c](https://github.com/IbbyLabs/aiometadata/commit/640436cb3a536ba434bb8bf17868d1ec07381e4e))
* **mobile:** polish mobile UI across settings, modals, and bulk actions ([9032b04](https://github.com/IbbyLabs/aiometadata/commit/9032b0436fce2a7997f4aa14008148e07cccdda5))
* move active user tracking to response phase where req.params exists ([c3ee1a4](https://github.com/IbbyLabs/aiometadata/commit/c3ee1a4acd1b9c1ba3f0ea6069e3395a744269f5))
* move age rating filter to post-cache processing and convert files to TypeScript ([d80dfa6](https://github.com/IbbyLabs/aiometadata/commit/d80dfa69d5489cfd60e5147dc67db41051ca52cf))
* move custom art URL overrides to post-processing outside cache ([a00222e](https://github.com/IbbyLabs/aiometadata/commit/a00222ea60e8e4a19b114365fcb33d7c38994fc0))
* normalize Fribb themoviedb_id object to plain numeric ID at ingestion ([67c1f12](https://github.com/IbbyLabs/aiometadata/commit/67c1f12af4b891293ffe17a7aa68ec88badbd9d6))
* ONA type detection in Kitsu search ([e286f6a](https://github.com/IbbyLabs/aiometadata/commit/e286f6af6000272d3126bf2faf2a6b45b3ea601d))
* only run scheduled tasks if e-tag has changed ([3b69ac3](https://github.com/IbbyLabs/aiometadata/commit/3b69ac36e4e2a47f36c4d4cd1f8e4bd93d35de3d))
* optimize catalog cache hit logging ([845ef8e](https://github.com/IbbyLabs/aiometadata/commit/845ef8e6b8837988b28318ce41ce65316df6ba56))
* pagination logic by using Math.ceil for page-based catalogs ([21d675e](https://github.com/IbbyLabs/aiometadata/commit/21d675eb5e670fd4bbab5fe03999de9a4b59e2bb))
* **parseProps:** custom poster rating provider falling through to RPDB ([a00222e](https://github.com/IbbyLabs/aiometadata/commit/a00222ea60e8e4a19b114365fcb33d7c38994fc0))
* poster cache stats now poll live like other ops tab queries ([d7e29e2](https://github.com/IbbyLabs/aiometadata/commit/d7e29e25be0cbd55c59bb2a73f3d919a76d2e1ce))
* preserve season objects for imdb series episode mapping ([cf4db3d](https://github.com/IbbyLabs/aiometadata/commit/cf4db3d9e1ab57976d2d6d295e765650d8bb2d89))
* preserve tags and merge membership when editing discover catalog filters ([e1569a5](https://github.com/IbbyLabs/aiometadata/commit/e1569a532c056732ea162bb5ee068acc2ba43bb7))
* preserve TVDB search results for niche shows without posters ([577c5b6](https://github.com/IbbyLabs/aiometadata/commit/577c5b6b458c4dcb6e08041a58d84befd891dd1a))
* prevent cross-provider poisoning of anime meta components ([24f42a3](https://github.com/IbbyLabs/aiometadata/commit/24f42a3a463e3a22b8b8b0d24d975f4214d6e9e5))
* prevent cross-user meta component cache contamination ([3ab12d0](https://github.com/IbbyLabs/aiometadata/commit/3ab12d09dd1d628443e3f8de5e46a479c18eaf1b))
* prevent double age-rating filtering on search results ([ba334e1](https://github.com/IbbyLabs/aiometadata/commit/ba334e14d88f9c64e8e224fb3467da0d3ff73baa))
* prevent logo crush on mobile with long testing version tags ([1b57773](https://github.com/IbbyLabs/aiometadata/commit/1b5777306cf89476f10bd89843f73a716d935525))
* re-read warmup config from env so dashboard-applied settings take effect ([2c3ce26](https://github.com/IbbyLabs/aiometadata/commit/2c3ce26bfa64a6d2da058595d50e11da511ba909))
* recover correct TVDB id via IMDb lookup when a mapped id returns no data ([3e9dce1](https://github.com/IbbyLabs/aiometadata/commit/3e9dce19e05e895bb505164e2b18c0444684b8e2))
* redesign mobile bulk action bar as a compact scrollable icon row ([6423c04](https://github.com/IbbyLabs/aiometadata/commit/6423c0485220497ec6e112a5d82158faa57f33f9))
* reduce redis RDB snapshot frequency to hourly ([4ebf84e](https://github.com/IbbyLabs/aiometadata/commit/4ebf84e47a570177d00b823a296e0339e044e3a9))
* reduce redis RDB snapshot frequency to prevent excessive disk writes ([c6684c6](https://github.com/IbbyLabs/aiometadata/commit/c6684c6004e886eeb6e3c56e48dc4299e143a60d))
* **release dates:** use air date + country of origin to determine release date format. ([5fa60ce](https://github.com/IbbyLabs/aiometadata/commit/5fa60ce8ddc003a7cda3fd1781be8ca6bb1b89a2))
* remove double-filtering for stremthru catalogs in index.js ([876da47](https://github.com/IbbyLabs/aiometadata/commit/876da473f943875b59469de12512921ea021f356))
* remove duplicate director/writer links for TMDB series ([eba777f](https://github.com/IbbyLabs/aiometadata/commit/eba777fe2bf0616325f008780c7878316aa09339))
* remove unused pageSize setting from custom manifest catalogs ([a68be3f](https://github.com/IbbyLabs/aiometadata/commit/a68be3fb021ea09c5ad0a8e8ab281f6f9010d90b))
* resolve 'retain' anime_id_provider to actual provider for correct episode IDs ([403fcd3](https://github.com/IbbyLabs/aiometadata/commit/403fcd3a92f8777efe47eb16f1e57a002d85ebc8)), closes [#263](https://github.com/IbbyLabs/aiometadata/issues/263)
* resolve shared config state leaking across concurrent requests ([7682e53](https://github.com/IbbyLabs/aiometadata/commit/7682e53aaf775254b86e6618dfc0180c1d10ece8))
* resolve undefined skip and pageSize references after page-based refactor ([cb83e5d](https://github.com/IbbyLabs/aiometadata/commit/cb83e5d8364452fe40ecb31e1ab257b26af1398a))
* respect merged catalog position in manifest ordering ([d067767](https://github.com/IbbyLabs/aiometadata/commit/d067767c3fdf76657ca74c66aa5fcc54d74bba1d))
* restore bulk delete for all non-merged catalogs ([f2f84f5](https://github.com/IbbyLabs/aiometadata/commit/f2f84f5eb77a102ce5c9573d0b2a18f1c24d32c8))
* restore poster proxy URL passthrough mode in meta handler ([e55523d](https://github.com/IbbyLabs/aiometadata/commit/e55523dc481157f76f7f5fd2bfe8f25abfec3f7f))
* resync episode availability on cache reconstruction ([5407ba3](https://github.com/IbbyLabs/aiometadata/commit/5407ba368d3144e92d33c290875890e3735512e1))
* retry TVDB requests on HTTP/2 GOAWAY frames ([da13382](https://github.com/IbbyLabs/aiometadata/commit/da13382088f02c7d8fe843de64eca42f88937538))
* reuse loaded config in catalog and search wrappers ([e766f0d](https://github.com/IbbyLabs/aiometadata/commit/e766f0d25fd7726d6632fc2ba82d9846f8f6d36a))
* revert AniList auth to authorization code grant ([122a76a](https://github.com/IbbyLabs/aiometadata/commit/122a76aee768295e4c4c7e43e6e37638c0c078c7))
* revert full-DB dashboard stats aggregation back to bounded 250-sample ([652aff0](https://github.com/IbbyLabs/aiometadata/commit/652aff023a3a32ae9448e53f916793e6c1066423))
* rewrite external addon catalog pagination with cursor tracking ([876da47](https://github.com/IbbyLabs/aiometadata/commit/876da473f943875b59469de12512921ea021f356))
* route content filtering through single applyCatalogFilters chokepoint ([7bb8acf](https://github.com/IbbyLabs/aiometadata/commit/7bb8acfaf72382c750ee04e3aa290a0d51f05d70))
* route poster warming through poster-cache proxy ([2866304](https://github.com/IbbyLabs/aiometadata/commit/2866304797d144206458728f524c7f3cade0c3d9))
* RPDB toggle for movie/series no longer shares state ([bcde593](https://github.com/IbbyLabs/aiometadata/commit/bcde593b7bf58a3a2e643f6d671950bc9349e3f1))
* scope simkl watchlist activity watermark per status ([af009d7](https://github.com/IbbyLabs/aiometadata/commit/af009d77031e3932958b3d2c6bc07e3646bab3a8))
* search rating posters using wrong config keys and consolidate search UI controls ([0aaa8f8](https://github.com/IbbyLabs/aiometadata/commit/0aaa8f828541647dd4150801a724509a586874de))
* short-circuit MDBList requests when quota exhausted ([cace872](https://github.com/IbbyLabs/aiometadata/commit/cace872e3f088fb552e4ea547fc1acdab938b7b1))
* **simkl:** fix plan to watch and on hold items order ([cc56f96](https://github.com/IbbyLabs/aiometadata/commit/cc56f9611bd3b36d19c692c41bcbfa29404394b0))
* **simkl:** fix simkl trending and calendar not being accessible without login ([28ed1e6](https://github.com/IbbyLabs/aiometadata/commit/28ed1e69afa3b9d051bb6112b100bf3b863a1246))
* sort Simkl plantowatch/hold by added_to_watchlist_at instead of reverse() ([3d5812e](https://github.com/IbbyLabs/aiometadata/commit/3d5812e8852c9073574cfae4052ea1fe5b48eae8))
* stack Input+Button pairs vertically on mobile across integration modals ([4852511](https://github.com/IbbyLabs/aiometadata/commit/485251169c5919074af323738656850eb9ae2022))
* stamp cross-ids on the tvdb anime catalog meta route ([cbb70fa](https://github.com/IbbyLabs/aiometadata/commit/cbb70faecf12e79b00ffb62bcbed696cdca4fc97))
* stamp tmdb/tvdb/imdb/kitsu/mal ids on anime catalog metas so custom art patterns resolve ([977fc72](https://github.com/IbbyLabs/aiometadata/commit/977fc72e27469752dfce0d7eb4c0ae9f8ca2587b))
* stop extras cache from overwriting cast and crew ([0ae730e](https://github.com/IbbyLabs/aiometadata/commit/0ae730e4e011b94cda395447f840f2d1fb4ceb84))
* stop filtering exact search matches as obscure content ([d73d421](https://github.com/IbbyLabs/aiometadata/commit/d73d4217f259f35935071185b6b0ff03f8bd3a11))
* stream expiring-key cleanup ([42d1d18](https://github.com/IbbyLabs/aiometadata/commit/42d1d1830d7a55bc68f034ee0d93d4cc809379c4))
* strip lang parameter for RPDB t0 free tier compatibility ([eaf38c8](https://github.com/IbbyLabs/aiometadata/commit/eaf38c881e87fd2c8ab32d6b498d660f6407794e))
* tighten up redis initialization sequence ([e341620](https://github.com/IbbyLabs/aiometadata/commit/e34162022353fd3df00e0ffd0705e6c255a2a5b5))
* timezone-aware dashboard stats + dark theme fixes ([46461f2](https://github.com/IbbyLabs/aiometadata/commit/46461f2fc611d0ea321c42ad88ba57f1ba43f12e))
* timing endpoint perf + Trakt 429 refresh cooldown ([8064282](https://github.com/IbbyLabs/aiometadata/commit/80642828eb6b5f45f3d14c26399957e2c951aa39))
* **tmdb people search:** reduce popularity threshold and improve logic ([978742b](https://github.com/IbbyLabs/aiometadata/commit/978742b7081fc67481b2da6f26cfd32d5801db95))
* touch-up kitsu ([9818288](https://github.com/IbbyLabs/aiometadata/commit/9818288026d9fa38e0d74853f7a8808af9473ca9))
* trakt 401 token refresh and custom poster pattern preservation ([f4a201b](https://github.com/IbbyLabs/aiometadata/commit/f4a201bae2460ea3585bff3251e80afc68e4d888))
* trakt handling enhancements ([e4f249e](https://github.com/IbbyLabs/aiometadata/commit/e4f249e0e05352ad48365aab8bca82c1960d32d7))
* trakt handling enhancements ([921bc66](https://github.com/IbbyLabs/aiometadata/commit/921bc661f6cf88ede70599ef335dfb920759afe9))
* trakt token refresh bypass in checkin, proxy, and rating flows ([e680ca9](https://github.com/IbbyLabs/aiometadata/commit/e680ca99045745aaa71d94abe0b102b5033bc002))
* trakt up next caching and UI improvements ([e7cffd7](https://github.com/IbbyLabs/aiometadata/commit/e7cffd7eb1622cf6bd9b2ed8bd1feb11d38f82b7))
* **trakt:** improve routing of auth'ed vs unauth'ed requests to correct queue for trakt rate limits handling ([77f64f5](https://github.com/IbbyLabs/aiometadata/commit/77f64f57fa2ddc9e1dbd29f52b492c8e7f7f7224))
* **trakt:** improve routing of auth'ed vs unauth'ed requests to correct queue for trakt rate limits handling ([c0c860d](https://github.com/IbbyLabs/aiometadata/commit/c0c860dd83a39e7f40eaa61bf077127bdccf1a95))
* **trakt:** pass proxy dispatcher to post requests in trakt.ts ([441d7b2](https://github.com/IbbyLabs/aiometadata/commit/441d7b2c60189eefb29b39a7d6d1ab4f41112142))
* **tvdb meta for anime:** add fallback to tvdb's db imdb id when anime mapping fails ([a82dad6](https://github.com/IbbyLabs/aiometadata/commit/a82dad664e265b24b22d09736c9a312eeabe6ce2))
* unresponsive UI after closing find & replace type modal ([b0c1b53](https://github.com/IbbyLabs/aiometadata/commit/b0c1b53494a7cc10617534810a17b7b056b43d74))
* update this endpoint to handle he new architecture ([4425bb5](https://github.com/IbbyLabs/aiometadata/commit/4425bb51f4c3f20215a651f11a558393f4f4b72f))
* use AniList implicit grant to bypass Cloudflare-blocked token endpoint ([fb4db5a](https://github.com/IbbyLabs/aiometadata/commit/fb4db5a0aa631ab081bc0859ee74ab286d1cfe0b))
* use default import for JSON modules to preserve `default` key ([eb9b74d](https://github.com/IbbyLabs/aiometadata/commit/eb9b74d28ab3fef1923712006699bba0345e3b58))
* use Math.floor for skip→page conversion and simplify search URL parsing ([c1ec9f3](https://github.com/IbbyLabs/aiometadata/commit/c1ec9f3fdd3d18c82c5b3ba726e2cbc9451d4e56))
* use unsaved AI keys for catalog generation ([460792a](https://github.com/IbbyLabs/aiometadata/commit/460792abb2762db8fb5ea11131ac65c38de92e75))
* user-scoped discover links in cache ([2c87840](https://github.com/IbbyLabs/aiometadata/commit/2c878403c504224554497cf7722cf553d900259e))
* user-scoped discover links in cache ([c3d6f54](https://github.com/IbbyLabs/aiometadata/commit/c3d6f548571c493c9cf18455f55e90836db579db))
* verify nameToImdb title match before stamping imdb id ([c2aaeae](https://github.com/IbbyLabs/aiometadata/commit/c2aaeae543032b57acdde6498a052bd4ed06eb96))
* warm poster proxy URLs with fallback params to match live requests ([c779eff](https://github.com/IbbyLabs/aiometadata/commit/c779effe919eb710c7ffb5d95d241696cebfd1c9))
* **warming:** Fix byoc warming that was broken due to missing dependency ([04247c1](https://github.com/IbbyLabs/aiometadata/commit/04247c142a71cddce6287ab4e3120d5e27f1c698))


### Performance Improvements

* add heap snapshot endpoint for testing ([a72fb80](https://github.com/IbbyLabs/aiometadata/commit/a72fb80f97a24054fc16e5e62f14350ec813f589))
* add heap snapshot endpoint for testing ([25d3d62](https://github.com/IbbyLabs/aiometadata/commit/25d3d62dccd8f838da1d7a1b15bb284100520e48))
* apply PR optimizations to ConfigCache ([b8bb898](https://github.com/IbbyLabs/aiometadata/commit/b8bb8982c3f0bb10702db8739aded2fddec24f04))
* batch redis writes for meta components ([6389498](https://github.com/IbbyLabs/aiometadata/commit/6389498c7ecca20aa8c2a64710d6dd3fb49b335c))
* broaden cache key sharing across MDBList, Trakt, AniList, and catalog-level caches ([659e5ac](https://github.com/IbbyLabs/aiometadata/commit/659e5ac0ec08d9d44097266c319556cc5159414d))
* cache anime-list season groups and episode mapping parses ([2e37be7](https://github.com/IbbyLabs/aiometadata/commit/2e37be760d35eb4c7f9e3bde02322776e65d63b3))
* cache MAX_CATALOGS env var and remove narrative comments ([cf5b85c](https://github.com/IbbyLabs/aiometadata/commit/cf5b85cf4517c168aa9881fc3259792f054ff2a4))
* deduplicate concurrent cache misses with in-flight locks ([f4dc3ac](https://github.com/IbbyLabs/aiometadata/commit/f4dc3ac7f01ac8ebd21a20036831577e8f12a211))
* deduplicate concurrent cache misses with in-flight locks ([7409729](https://github.com/IbbyLabs/aiometadata/commit/7409729f234569e0c7bd5eb709e8f3f85ab697cc))
* enable auto pipelining ([#376](https://github.com/IbbyLabs/aiometadata/issues/376)) ([6129570](https://github.com/IbbyLabs/aiometadata/commit/612957094d17106f9d0a889a7a9907e0fd203a3a))
* implement batch TMDB episode resolver for kitsu ([16a1f9e](https://github.com/IbbyLabs/aiometadata/commit/16a1f9ee4f15f4d89c53ef8e38f650fba0e54e9b))
* improve up next fetching logic for speed ([79c51ec](https://github.com/IbbyLabs/aiometadata/commit/79c51ec995a766e65b07674dfb7d1023cc6ef552))
* lazily load TMDB languages for language catalog ([9cfecee](https://github.com/IbbyLabs/aiometadata/commit/9cfeceea0ce95900b4534330c31a47589a4f1ef0))
* migrate sqlite3 to better-sqlite3 ([088d62b](https://github.com/IbbyLabs/aiometadata/commit/088d62b8e1b99190e836cc9ffafc0f4b9362f28f))
* normalize and reduce Redis cache payload sizes ([#473](https://github.com/IbbyLabs/aiometadata/issues/473)) ([2574288](https://github.com/IbbyLabs/aiometadata/commit/2574288e35d18b60853ede8c3ea98493dc5d0303))
* optimize etag logic ([4e42d9a](https://github.com/IbbyLabs/aiometadata/commit/4e42d9ad28647960ac02b0bd27fcf5e7864607e3))
* optimize id-mapper lookups ([6b4c71b](https://github.com/IbbyLabs/aiometadata/commit/6b4c71beef85c0dcb68cb09bc8a7f89f179fd76e))
* optimize meta cache config reuse in fanout paths ([e1b852f](https://github.com/IbbyLabs/aiometadata/commit/e1b852f0eed911fd03762b3fe79e7f1d245d060a))
* optimize release timestamp handling in metadata builders ([9f9934e](https://github.com/IbbyLabs/aiometadata/commit/9f9934ee9238a778662ea75e54027c70308e35f7))
* reduce content metadata writes on component cache hits ([9fe914d](https://github.com/IbbyLabs/aiometadata/commit/9fe914decfcc89397c70d3a001f524b7b176ef33))
* reduce frontend bundle size ([d46e210](https://github.com/IbbyLabs/aiometadata/commit/d46e210068f5eb24a80b8e1f23b8536558b56619))
* remove unbounded requestTimestamps array in pmdb utils ([f69515d](https://github.com/IbbyLabs/aiometadata/commit/f69515df1f09a7c7461bd8d37a1b73d4b4ca9bc0))
* replace checkIfExists (head+get) with single piped get ([2241200](https://github.com/IbbyLabs/aiometadata/commit/224120049e4123ca6f0deaaf103653de764559fc))
* scope providers/artProviders per content type in catalog cache keys ([2f0cb1c](https://github.com/IbbyLabs/aiometadata/commit/2f0cb1c6a8f04125257a8017e0b1bc2cc861ae9b))
* short circuit request tracker ([031ea46](https://github.com/IbbyLabs/aiometadata/commit/031ea462ae15dcd677e3d51dadbd9c1e27e7fe8f))
* simplify catalog warmer interrupted detection ([876da47](https://github.com/IbbyLabs/aiometadata/commit/876da473f943875b59469de12512921ea021f356))
